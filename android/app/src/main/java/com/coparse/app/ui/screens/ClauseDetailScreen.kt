...
fun ClauseDetailScreen(
    ...
    Column(
        ...
        Text(text = c.theme.replaceFirstChar { it.titlecase() }, style = MaterialTheme.typography.headlineSmall)
        Text(text = "Risk: ${c.riskLevel}", style = MaterialTheme.typography.titleMedium)
